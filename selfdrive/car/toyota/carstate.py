...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.carFingerprint != CAR.PRIUS_V:
      ...
      if not self.prev_lkas_enabled and self.lkas_enabled and not self.params.get_bool("SteerAlwaysOn") and ret.cruiseState.available:
        self.params.put_bool('SteerAlwaysOn', True)
      elif (self.prev_lkas_enabled and not self.lkas_enabled and self.params.get_bool("SteerAlwaysOn")) or not ret.cruiseState.available:
        self.params.put_bool('SteerAlwaysOn', False)
      if self.params.get_bool("SteerAlwaysOn"):
